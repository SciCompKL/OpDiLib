...
struct TestOrderedMultiple : public TestBase<4, 1, 3, TestOrderedMultiple<_Case>> {
  public:
    using Case = _Case;
    using Base = TestBase<4, 1, 3, TestOrderedMultiple<Case>>;
