...
struct TestParallelReductionMultiple : public TestBase<4, 1, 3, TestParallelReductionMultiple<_Case>> {
  public:
    using Case = _Case;
    using Base = TestBase<4, 1, 3, TestParallelReductionMultiple<Case>>;
    ...
    static void test(std::array<T, Base::nIn> const& in, std::array<T, Base::nOut>& out) {
      ...
      OPDI_PARALLEL(OPDI_REDUCTION reduction(plus: output1) reduction(prod: output2, output3))
      {
